...
import logoImg from "../assets/logGym.png";
          ...
          <div className={classes.footer_left}>
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  {" "}
                  <Link to="/leadership">مدربينا </Link>{" "}
                </li>
                <li>
                  {" "}
                  <Link to="/aboutUs/news">أخبارنا </Link>{" "}
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul>
                <li>
                  {" "}
                  <Link to="/student/acadimics">برنامج الملاكمة</Link>{" "}
                </li>
                <li>
                  {" "}
                  <Link to="/student/secondGrade">
                    برنامج كمال الأجسام
                  </Link>{" "}
                </li>
                <li>
                  {" "}
                  <Link to="/student/thirdGrade">برنامج الكاراتيه </Link>{" "}
                </li>
              </ul>
            </div>
          </div>
